...
try:
    import lerobot_teleoperator_zhonglin  # noqa: F401
except ImportError:
    pass
...
def make_teleoperator_from_config(config: TeleoperatorConfig) -> Teleoperator:
    ...
    elif config.type == "keyboard_pose":
        from .keyboard.teleop_keyboard import KeyboardPoseTeleop

        return KeyboardPoseTeleop(config)
