...
def test_build_dataset_frame_accepts_fully_qualified_image_keys():
    ...
    frame = build_dataset_frame(features, {f"{OBS_IMAGES}.front": image}, prefix=OBS_STR)

    assert frame[f"{OBS_IMAGES}.front"] is image
